...
(() => {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    function updateGravatarImages(email) {
  ...
  // node_modules/.pnpm/@finsweet+cookie-consent@1.13.2/node_modules/@finsweet/cookie-consent/fs-cc.js
  (() => {
    var Qe = Object.defineProperty;
    var Xe = (n, e, t) => e in n ? Qe(n, e, { enumerable: true, configurable: true, writable: true, value: t }) : n[e] = t;
    var p = (n, e, t) => (Xe(n, typeof e != "symbol" ? e + "" : e, t), t);
    var F = (n, e = "flex") => new Promise((t) => {
      n.style.opacity = "0", n.style.display = e, function o() {
    ...
    p(C, "alertsActivated", false);
    var g = (n, e) => !!n && e.includes(n);
    var T = (n, e) => (Array.isArray(e) || (e = [e]), e.map((o) => n.dispatchEvent(new Event(o, { bubbles: true }))).every((o) => o));
    function le(n, e, t, o = true) {
      let r = t ? [t] : [];
      if (!n)
        return r;
    ...
    var fe = (n) => n.replace(/\/+$/, "");
    var Y = (n, e = true) => (e !== n.checked && (n.checked = e, T(n, ["click", "input", "change"])), n.type === "checkbox" ? n.checked : n.value);
    var Se = (n) => new Promise((e) => setTimeout(e, n));
    var G = class {
      constructor({ element: e, duration: t }) {
        p(this, "element");
        p(this, "active", false);
        p(this, "running", false);
        ...
        var o, r;
        this.element = typeof e == "string" ? y(e, HTMLElement) || C.alert(`No interaction with the ${e} selector was found.`, "error") : e, this.duration = { first: typeof t == "number" ? t : (o = t == null ? void 0 : t.first) != null ? o : 0, second: typeof t == "number" ? t : (r = t == null ? void 0 : t.second) != null ? r : 0 };
      }
      async trigger(e) {
        return e === "first" && this.active || e === "second" && !this.active ? false : (e || (e = this.active ? "second" : "first"), T(this.element, "click"), this.running = true, this.runningPromise = Se(this.duration[e]), await this.runningPromise, this.running = false, this.active = e === "first", true);
      }
    };
    var O = class {
      constructor({ element: e, interaction: t, displayProperty: o, noTransition: r, startsHidden: s }) {
        ...
        if (this.element = typeof e == "string" ? y(e, HTMLElement) || C.alert(`No element with the ${e} selector was found.`, "error") : e, this.noTransition = r, this.displayProperty = o || "block", s ? (this.element.style.display = "none", this.visible = false) : this.visible = xe(this.element), t) {
          let { element: i, duration: a } = t;
          this.interaction = new G({ element: i, duration: a });
        }
      }
      async show() {
        this.visible || (this.interaction ? await this.interaction.trigger("first") : this.noTransition ? this.element.style.display = this.displayProperty : await F(this.element, this.displayProperty), this.visible = true);
      }
      async hide() {
        this.visible && (this.interaction ? await this.interaction.trigger("second") : this.noTransition ? this.element.style.display = "none" : await D(this.element), this.visible = false);
      }
    };
    ...
    var he = false;
    typeof window != "undefined" && (me = { get passive() {
      he = true;
    } }, window.addEventListener("testPassive", null, me), window.removeEventListener("testPassive", null, me));
    var me, J = typeof window != "undefined" && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || window.navigator.platform === "MacIntel" && window.navigator.maxTouchPoints > 1), M = [], Q = false, ye = -1, U = void 0, A = void 0, R = void 0, Te = function(e) {
      return M.some(function(t) {
        return !!(t.options.allowTouchMove && t.options.allowTouchMove(e));
      });
    }, X = function(e) {
      var t = e || window.event;
      return Te(t.target) || t.touches.length > 1 ? true : (t.preventDefault && t.preventDefault(), false);
    }, et = function(e) {
      if (R === void 0) {
        var t = !!e && e.reserveScrollBarGap === true, o = window.innerWidth - document.documentElement.clientWidth;
        if (t && o > 0) {
      ...
      return window.requestAnimationFrame(function() {
        if (A === void 0) {
          A = { position: window.top.body.style.position, top: window.top.body.style.top, left: window.top.body.style.left };
      ...
      return Te(e.target) ? false : t && t.scrollTop === 0 && o > 0 || rt(t) && o < 0 ? X(e) : (e.stopPropagation(), true);
    }, Oe = function(e, t) {
      if (!e) {
      ...
      if (!M.some(function(r) {
        ...
        }, Q || (document.addEventListener("touchmove", X, he ? { passive: false } : void 0), Q = true));
      }
    }, Ae = function() {
      J && (M.forEach(function(e) {
        e.targetElement.ontouchstart = null, e.targetElement.ontouchmove = null;
      }), Q && (document.removeEventListener("touchmove", X, he ? { passive: false } : void 0), Q = false), ye = -1), J ? nt() : tt(), M = [];
    };
    var w = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakMap(), b = /* @__PURE__ */ new WeakMap();
    var te = Symbol("anyProducer"), ke = Promise.resolve(), oe = Symbol("listenerAdded"), ne = Symbol("listenerRemoved"), re = false, be = false;
    function I(n) {
    ...
    function j(n, e) {
      let t = typeof e == "string" || typeof e == "symbol" || typeof e == "number" ? e : te, o = b.get(n);
      if (o.has(t))
        return o.get(t);
    }
    function st(n, e, t) {
    ...
    function Me(n, e) {
      ...
      for (let i of e) {
        let a = j(n, i);
        a || (a = /* @__PURE__ */ new Set(), b.get(n).set(i, a)), a.add(s);
      }
      return { async next() {
        ...
        return o(), arguments.length > 0 ? { done: true, value: await i } : { done: true };
    ...
    var h = class n {
      static mixin(e, t) {
        return t = Ie(t), (o) => {
          ...
          function r() {
            return Object.defineProperty(this, e, { enumerable: false, value: new n() }), this[e];
          }
          Object.defineProperty(o.prototype, e, { enumerable: false, get: r });
          let s = (i) => function(...a) {
            return this[e][i](...a);
          };
          for (let i of t)
            Object.defineProperty(o.prototype, i, { enumerable: false, value: s(i) });
          return o;
        };
      }
      static get isDebugEnabled() {
        ...
        if (typeof ((t = globalThis.process) == null ? void 0 : t.env) != "object")
          return be;
        let { env: e } = (o = globalThis.process) != null ? o : { env: {} };
      ...
      constructor(e = {}) {
        var t;
        w.set(this, /* @__PURE__ */ new Set()), x.set(this, /* @__PURE__ */ new Map()), b.set(this, /* @__PURE__ */ new Map()), b.get(this).set(te, /* @__PURE__ */ new Set()), this.debug = (t = e.debug) != null ? t : {}, this.debug.enabled === void 0 && (this.debug.enabled = false), this.debug.logger || (this.debug.logger = (o, r, s, i) => {
          try {
            i = JSON.stringify(i);
          } catch {
	...
	data: ${i}`);
      ...
      on(e, t) {
        ...
        for (let o of e) {
          I(o);
          let r = P(this, o);
          r || (r = /* @__PURE__ */ new Set(), x.get(this).set(o, r)), r.add(t), this.logIfDebugEnabled("subscribe", o, void 0), L(o) || ee(this, oe, { eventName: o, listener: t });
        }
      ...
      off(e, t) {
        ...
        for (let o of e) {
          I(o);
          let r = P(this, o);
          r && (r.delete(t), r.size === 0 && x.get(this).delete(o)), this.logIfDebugEnabled("unsubscribe", o, void 0), L(o) || ee(this, ne, { eventName: o, listener: t });
        }
      }
      once(e) {
      ...
      async emit(e, t) {
        ...
        let o = (a = P(this, e)) != null ? a : /* @__PURE__ */ new Set(), r = w.get(this), s = [...o], i = L(e) ? [] : [...r];
      ...
      async emitSerial(e, t) {
        ...
        let o = (a = P(this, e)) != null ? a : /* @__PURE__ */ new Set(), r = w.get(this), s = [...o], i = [...r];
        await ke;
        for (let c of s)
          o.has(c) && await c(t);
        for (let c of i)
      ...
      onAny(e) {
        return Z(e), this.logIfDebugEnabled("subscribeAny", void 0, void 0), w.get(this).add(e), ee(this, oe, { listener: e }), this.offAny.bind(this, e);
      }
      anyEvent() {
        return Me(this);
      }
      offAny(e) {
        Z(e), this.logIfDebugEnabled("unsubscribeAny", void 0, void 0), ee(this, ne, { listener: e }), w.get(this).delete(e);
      }
      clearListeners(e) {
        e = Array.isArray(e) ? e : [e];
        for (let t of e)
      ...
      bindMethods(e, t) {
        ...
        for (let o of t) {
          ...
          Object.defineProperty(e, o, { enumerable: false, value: this[o].bind(this) });
        }
      }
    }, Pe = Object.getOwnPropertyNames(h.prototype).filter((n) => n !== "constructor");
    Object.defineProperty(h, "listenerAdded", { value: oe, writable: false, enumerable: true, configurable: false });
    Object.defineProperty(h, "listenerRemoved", { value: ne, writable: false, enumerable: true, configurable: false });
    var at = ["essential"], ge = ["personalization", "analytics", "marketing"], we = "uncategorized", ie = [...at, ...ge, we], f = "fs-cc", wo = f + "-ie", Le = ["informational", "opt-in", "opt-out"], B = { allow: "allow", deny: "deny", submit: "submit" }, E = { banner: `[${f}="banner"]`, preferences: `[${f}="preferences"]`, manager: `[${f}="manager"]` }, S = { allow: `[${f}="${B.allow}"]`, deny: `[${f}="${B.deny}"]`, submit: `[${f}="${B.submit}"]`, openPreferences: `[${f}="open-preferences"]`, close: `[${f}="close"]` }, Ee = { interactionTrigger: `[${f}="interaction"]` }, m = { categories: [`${f}-category`, `${f}-categories`], disableScroll: `${f}-scroll`, displayProperty: `${f}-display`, cookieMaxAge: `${f}-expires`, mode: `${f}-mode`, debugMode: `${f}-debug`, endpoint: `${f}-endpoint`, componentsSource: `${f}-source`, src: `${f}-src`, placeholder: `${f}-placeholder`, domain: `${f}-domain` }, $ = { main: f, consentsUpdated: `${f}-updated` };
    var H = { checkbox: (n) => `[${f}-checkbox="${n}"]`, gtmEvent: (n) => `${n}-activated` };
    var $e = `<style>${E.banner},${E.manager},${E.preferences},${Ee.interactionTrigger}{display:none}</style>`;
    var ct = { info: "green", warning: "yellow", error: "red" }, d = class {
      static activate() {
      ...
      static alert(e, t) {
        ...
        Object.assign(o.style, { position: "relative", padding: "16px", opacity: "0", "margin-bottom": "16px", "border-left": `4px solid ${ct[t]}`, "background-color": "#fff", "box-shadow": "1px 1px 3px 0 rgba(0, 0, 0, 0.1)", "word-break": "break-all" });
    ...
    d.active = false;
    var se = Object.freeze({ analytics: false, essential: true, marketing: false, personalization: false, uncategorized: false }), K = Object.freeze({ analytics: true, essential: true, marketing: true, personalization: true, uncategorized: true }), Fe = "180";
    var _ = class {
      constructor() {
        ...
        this.getActivableElements = () => this.getStoredElements().filter(({ active: e2, categories: t2 }) => !e2 && t2.every((o2) => this.consents[o2]));
    ...
    var De = async (n) => {
      let { origin: e, pathname: t, href: o } = window.location, { origin: r, pathname: s, href: i } = new URL(document.baseURI);
      try {
        if (n.startsWith("/")) {
          let ce = i === o ? e : r + s;
          n = fe(ce) + n;
        ...
        if (a + c === e + t)
          return;
        let u = await (await fetch(n)).text(), Je = new DOMParser().parseFromString(u, "text/html");
    ...
    var q = class extends h {
      ...
      initElements() {
        let t = ge.filter((o) => {
          let r = H.checkbox(o), s = this.element.querySelector(`input${r}, ${r} input`);
          return !s || s.type !== "checkbox" ? true : (s.checked && Y(s, false), this.checkboxes.set(o, s), false);
        });
    ...
    var k = class extends h {
      ...
      initElements() {
        ...
        return this.displayController = new O({ element: t, interaction: i ? { element: i } : void 0, displayProperty: g(s, O.displayProperties) ? s : "flex", startsHidden: true }), true;
      }
      handleAccessibility() {
        let { element: t } = this;
        t && N(S).forEach((o) => {
      ...
      handleMouseAndKeyboard(t) {
        var c;
        let { target: o } = t, { allow: r, deny: s, close: i, submit: a } = S;
      ...
      show(t = true) {
        ...
        !o || !r || r.isVisible() === t || (r[t ? "show" : "hide"](), s && (t ? Oe(i || o, { reserveScrollBarGap: true }) : Ae()), this.emit(t ? "open" : "close"));
      }
      open() {
    ...
    var Be = async ({ id: n, endpoint: e, consents: t, action: o, bannerText: r }) => {
      if (e)
        try {
          let s = JSON.stringify({ id: n, action: o, consents: t, bannerText: r, url: window.location.href, userAgent: navigator.userAgent }), i = await fetch(e, { body: s, method: "POST" });
          if (i.ok)
    ...
    function ve(n, e) {
      function t(r, s, i) {
        if (typeof document != "undefined") {
          ...
          var a = "";
          for (var c in i)
            i[c] && (a += "; " + c, i[c] !== true && (a += "=" + i[c].split(";")[0]));
      ...
      return Object.create({ set: t, get: o, remove: function(r, s) {
        t(r, "", ae({}, s, { expires: -1 }));
      }, withAttributes: function(r) {
        return ve(this.converter, ae({}, this.attributes, r));
      }, withConverter: function(r) {
        return ve(ae({}, this.converter, r), this.attributes);
      } }, { attributes: { value: Object.freeze(e) }, converter: { value: Object.freeze(n) } });
    }
    var v = ve(lt, { path: "/" });
    ...
    var Ke = (n) => {
      ...
      let s = encodeURIComponent(JSON.stringify({ id: n, consents: e }));
      o = Ke(o), v.set($.main, s, { expires: t, domain: o });
    }, ze = () => {
      let n = v.get();
      for (let e in n) {
        if (e === $.main)
        ...
        for (; t.length > 1; )
          v.remove(e), v.remove(e, { domain: `.${t.join(".")}` }), v.remove(e, { domain: `${t.join(".")}` }), t.splice(0, 1);
      }
    }, We = () => !!v.get($.consentsUpdated), Ve = (n = 120, e) => {
      e = Ke(e), v.set($.consentsUpdated, "true", { expires: n, domain: e });
    };
    var Ye = (n) => {
      window.dataLayer = window.dataLayer || [], window.dataLayer.find((e) => e.event === n) || (window.dataLayer.push({ event: n }), d.alert(`The GTM event ${n} has been fired.`, "info"));
    };
    var z = class extends h {
      ...
      storeElements() {
        let { store: t } = this, o = document.querySelectorAll(`script[type="${f}"], iframe[${m.src}]`), r = t.getStoredElements();
        [...o].filter((i) => !r.find(({ element: a }) => i === a)).forEach((i) => {
          ...
          if (i instanceof HTMLScriptElement && t.storeScript({ categories: a, element: i, active: false }), i instanceof HTMLIFrameElement) {
            ...
            if (!c)
              return;
            i.src = "";
            let l = i.getAttribute(m.placeholder), u = l ? y(l, HTMLElement) : void 0;
            t.storeIFrame({ categories: a, element: i, src: c, placeholder: u, active: false });
          }
      ...
      async applyConsents() {
        ...
        for (let o of t.getActivableElements())
          await new Promise((r) => {
            ...
            let l = () => {
              o.element = c, o.active = true, r(void 0);
            };
      ...
      updateConsents(t, o) {
        let { store: r } = this, { cookieMaxAge: s, endpoint: i, domain: a } = r, c = r.storeConsents(t), l = je();
        qe(l, r.getConsents(), s, a), i && Be({ action: o, endpoint: i, id: l, consents: r.getConsents(), bannerText: r.getBannerText() || "" }), c.length && (Ve(s, a), this.applyConsents(), d.alert(`The following consents were updated: ${c.join(", ")}`, "info")), this.emit("updateconsents");
      }
    };
    var W = class {
      constructor(e = []) {
      ...
      async initComponents() {
        let { store: e } = this, { componentsSource: t } = e, { banner: o, preferences: r, manager: s } = E;
      ...
      listenEvents() {
        let { allow: e, deny: t, submit: o } = B, r = ["banner", "manager", "preferences"], { store: s, consentController: i, banner: a, manager: c } = this;
      ...
      handleMouseAndKeyboard(e) {
        let { target: t } = e, { banner: o, manager: r, preferences: s } = this;
  ...
  function updatePlanDetails(member, priceSelector = '[data-element="plan-price"]', renewalSelector = '[data-element="plan-renewal"]') {
    ...
    if (priceElement) {
      priceElement.textContent = currentPlan && currentPlan.payment ? `$${currentPlan.payment.amount}` : "Free";
    }
    if (renewalElement) {
      renewalElement.textContent = currentPlan && currentPlan.payment && currentPlan.payment.nextBillingDate ? formatDate(currentPlan.payment.nextBillingDate) : "N/A";
    }
  }
...
@finsweet/cookie-consent/fs-cc.js:
  (*! Bundled license information:
